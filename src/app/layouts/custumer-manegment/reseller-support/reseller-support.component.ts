...
@Component({
  selector: 'app-reseller-support',
  templateUrl: './reseller-support.component.html',
  styleUrls: ['./reseller-support.component.css']
})
export class ResellerSupportComponent implements OnInit {
  ...
  getAllCrmUserList(data) {
    if (!this.isListLoading) {
      ...
      const url = API.CRM_ENDPOINTS.RESLLER_HELP_AND_SUPPORT;
