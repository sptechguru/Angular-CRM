...
@Component({
  selector: 'app-reseller-feedback',
  templateUrl: './reseller-feedback.component.html',
  styleUrls: ['./reseller-feedback.component.css']
})
export class ResellerFeedbackComponent implements OnInit {
  ...
  getAllCrmUserList(data) {
    if (!this.isListLoading) {
      ...
      const url = API.CRM_ENDPOINTS.RESLLER_FEEDBACK;
