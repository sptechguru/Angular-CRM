...
@Component({
  selector: 'app-reseller-requests-quote',
  templateUrl: './reseller-requests-quote.component.html',
  styleUrls: ['./reseller-requests-quote.component.css']
})
export class ResellerRequestsQuoteComponent implements OnInit {
  ...
  getAllCrmUserList(data) {
    if (!this.isListLoading) {
      ...
      const url = API.CRM_ENDPOINTS.RESLLER_REQUEST_QOUTE;
